...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("AashikaMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("AashikaMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("AashikaMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("AashikaMusic/assets/play_icons.png")
